          ...
          <div className="px-6 py-5">
            ...
            <div className="space-y-4">
              <UsageMeter
                label="Leads"
                icon={Users}
                used={planData.usage.leads.used}
                max={planData.usage.leads.max}
                color="#3B82F6"
              />
              <UsageMeter
                label="Brand Audits"
                icon={BarChart2}
                used={planData.usage.audits.used}
                max={planData.usage.audits.max}
                color="#7C3AED"
              />
              <UsageMeter
                label="Outreach Emails"
                icon={Mail}
                used={planData.usage.emails.used}
                max={planData.usage.emails.max}
                color="#10B981"
              />
            </div>
          </div>
