...
import { Users, Calendar, FileText, TrendingUp, DollarSign, Award, CheckCircle2, Circle, CreditCard, Zap } from "lucide-react";
  ...
  return (
    <div className="p-4 md:p-6 space-y-4 md:space-y-6">
      ...
      <div>
        ...
        <p className="text-xs text-muted-foreground mt-0.5">Real-time sales intelligence — Dreamsdesign</p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-2.5 md:gap-3">
        <StatCard label="Total Leads" value={summary?.totalLeads ?? 0} icon={Users} color="teal" loading={isLoading} trend={`${summary?.totalLeadsThisMonth ?? 0} added this month`} />
