...
export default function Booking() {
  ...
  const [form, setForm] = useState({
    ...
    investmentWillingness: "", location: "meet",
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <div className="flex gap-2 mt-1">
                          {[{ val:"meet", label:"Google Meet", icon: Video }, { val:"inperson", label:"In-person", icon: MapPin }].map(({ val, label, icon: Icon }) => (
                  ...
                  <div className="w-full max-w-sm rounded-2xl border p-5 mb-6 text-left" style={{ borderColor: "#E5E7EB" }}>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between text-[13px]">
                        ...
                        <span className="font-semibold" style={{ color: "#111827" }}>{form.location === "meet" ? "Google Meet call" : "In-person"}</span>
                      </div>
                    </div>
                  </div>
